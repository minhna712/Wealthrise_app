...
export default function NotificationScreen({ onBack, onMarkAllRead }: Props) {
  const { userState, markNotificationRead } = useUserState();
  const { readNotificationIds } = userState;

  const hasUnread = NOTIFICATIONS.some(n => !n.read && !readNotificationIds.includes(n.id));
              ...
              >
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  <p style={{
                    ...
                    fontWeight:isRead?500:700, color:isRead?"#5F6368":"#2A2420",
                  }}>
                    {n.body}
                  </p>
